...
import { AnyType, ApiOptions } from '../declarations/types'
...
export default class ExceptionHandler {
  ...
  private buildAlertContext(exception: PresentationExceptionImpl) {
    ...
    const alertContext = new AlertContext(exception.StrMessage || '', [okButton], this.getAlertTitle(exception.IntType))
