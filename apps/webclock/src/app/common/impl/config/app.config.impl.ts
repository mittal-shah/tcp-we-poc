...
import InputMethodMapImpl from '../domain/input-method-map.impl'

export default class AppConfigImpl extends AbstractImpl implements AppConfig {
  ...
  getPagingPrefix() {
    return this.StrPageNumber ? Util.stringFormat(this.StrPageNumber, '').trim() : ''
  }
